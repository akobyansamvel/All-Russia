		...
		<div class="list">
			<div class="wrapper">
				<div class="list__top top">
					...
					<p class="top__text text-headdind">СТОЛИЦА РОССИЙСКОЙ ФЕДЕРАЦИИ</p>
					<div class="top__card card">
						<img class="card__img" src="@/assets/moscow_flag%201.png" alt="" />
						<div class="card__box">
							<p class="card__headding">Москва</p>
							<p class="card__text text-population">Население: 12 330 126 человек</p>
							<p class="card__text text-square">Площадь: 2,561 тыс.км²</p>
					...
					<div class="container__card">
						<div class="item item_1">
							...
							<div class="item__card">
								...
								<p class="card__text text-square">Площадь: 361.9 тыс. кв. км</p>
								<p class="card__text text-time">Часовой пояс:(UTC+9)</p>
							</div>
						</div>
						<div class="item item_2">
							...
							<div class="item__card">
								...
								<p class="card__text text-square">Площадь: 36.2 тыс. кв. км</p>
								<p class="card__text text-time">Часовой пояс:(UTC+9)</p>
							</div>
						</div>
						<div class="item item_3">
							...
							<div class="item__card">
								...
								<p class="card__text text-square">Площадь: 464.2 тыс. кв. км</p>
								<p class="card__text text-time">Часовой пояс:(UTC+9)</p>
							</div>
						</div>
						<div class="item item_4">
							...
							<div class="item__card">
								...
								<p class="card__text text-square">Площадь: 462.4 тыс. кв. км</p>
								<p class="card__text text-time">Часовой пояс:(UTC+9)</p>
							</div>
						</div>
						<div class="item item_5">
							...
							<div class="item__card">
								...
								<p class="card__text text-square">Площадь: 161 тыс. кв. км</p>
								<p class="card__text text-time">Часовой пояс:(UTC+9)</p>
							</div>
						</div>
						<div class="item item_6">
							...
							<div class="item__card">
								...
								<p class="card__text text-square">Площадь: 351 тыс. кв. км</p>
								<p class="card__text text-time">Часовой пояс:(UTC+9)</p>
							</div>
						</div>
						<div class="item item_7">
							...
							<div class="item__card">
								...
								<p class="card__text text-square">Площадь: 3 084 000 кв. км</p>
								<p class="card__text text-time">Часовой пояс:(UTC+9)</p>
							</div>
						</div>
						<div class="item item_8">
							...
							<div class="item__card">
								...
								<p class="card__text text-square">Площадь: 87 тыс. кв. км</p>
								<p class="card__text text-time">Часовой пояс:(UTC+9)</p>
							</div>
						</div>
						<div class="item item_9">
							...
							<div class="item__card">
								...
								<p class="card__text text-square">Площадь: 431 тыс. кв. км</p>
								<p class="card__text text-time">Часовой пояс:(UTC+9)</p>
							</div>
						</div>
						<div class="item item_10">
							...
							<div class="item__card">
								...
								<p class="card__text text-square">Площадь: 787 тыс. кв. км</p>
								<p class="card__text text-time">Часовой пояс:(UTC+9)</p>
							</div>
						</div>
					</div>
